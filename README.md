...
- Key Findings: The RF classifier did a solid job of predicting on the test set and yeilded an accuracy rate of about 84%. The features with the most influence on the model's thought process were the severity of chest pain and patient's thalassemia levels. Through the use of SHAP/LIME plots, we were able to see each how feature can pull or push the model to predict a certain way.
